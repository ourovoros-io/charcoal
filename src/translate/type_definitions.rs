...
pub fn translate_type_definition(
    ...
    let underlying_type = translate_type_name(project, module.clone(), &type_definition.ty, false, false);

    module.borrow_mut().type_definitions.push(sway::TypeDefinition {
        is_public: true,
